...
public class S3config {
	...
	public AmazonS3 amazonS3() {
		...
		if (!amazonS3.doesBucketExistV2(property.getS3().getBucket())) {
			...
			BucketLifecycleConfiguration.Rule ruleExpirated = new BucketLifecycleConfiguration.Rule()
			...
			BucketLifecycleConfiguration configuration = new BucketLifecycleConfiguration().withRules(ruleExpirated);
